...
from layers.Learning_to_Rotate_Attention import InducedLearningtoRotateAttentionLayer, LearningToRotateAttentionLayer
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.encoder = Encoder(
            [
                EncoderLayer(
                    InducedLearningtoRotateAttentionLayer(
                        self.seq_len, 
                        self.seq_len, 
                        configs.d_model, 
                        configs.n_heads, 
