...
from layers.Learning_to_Rotate_Attention import ComplexAttention, QuaternionAttention, FullAttention, LearningToRotateAttentionLayer
from layers.LRformer_EncDec import Encoder, Decoder, EncoderLayer, DecoderLayer, my_Layernorm, series_decomp, TrendNorm
import math
import numpy as np
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        attention_dict = {
            ...
            'complex': ComplexAttention,
            'quaternion': QuaternionAttention,
        }
        Attention = attention_dict[configs.attn_type]
        print(f'Attention type: {configs.attn_type}')
