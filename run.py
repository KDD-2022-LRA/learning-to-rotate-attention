...
parser.add_argument('--model', type=str, required=True, default='Autoformer',
                    help='model name, options: [LRformer, iLRformer, Autoformer, Informer, Transformer, Deformer]')
...
# attention settings
parser.add_argument('--attn_type', type=str, default='quaternion', 
                    help='attention type, options: [complex, quaternion, standard]')
